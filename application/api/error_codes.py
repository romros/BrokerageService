...
OSTIUM_POSITIONS_TIMEOUT = "OSTIUM_POSITIONS_TIMEOUT"  # T5.5: GET /positions ostium LIVE timeout
OSTIUM_POSITIONS_ERROR = "OSTIUM_POSITIONS_ERROR"      # T5.5: GET /positions ostium LIVE error
